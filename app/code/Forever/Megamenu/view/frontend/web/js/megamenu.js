            ...
            var methods    = {
                    ...
                    return this.each(function () {
                        ...
                        if ("IntersectionObserver" in window) {
                            ...
                            accordion.each(function () {
                                accordionObserver.observe(this);
                            });
                            ...
                            accordion.each(function () {
                                ...
                                el.magicaccordion($(this).data('menu-init'));
                            });
                            topmenu.each(function () {
                ...
                taphover: function (el) {
                    ...
                    categories.on('touchstart', function (e) {
                        /* 'touchstart click' if want for both touchstart and click */
                    ...
                    $(window).scroll(function () {
                        ...
                        if (postion > postionTop ) { /* not use = */
                            ...
                            if (heightItem && !menuAIO.hasClass('over')) {
                                ...
                                if (heightAIO > 0 ) {
                                    menuAIO.css({"height": heightAIO, "overflow": "hidden", "display": ''});
                                } else {
                ...
                horizontal: function ($navtop, fullWidth, init) {
                    if (init) {
                        methods.initMenu($navtop, fullWidth);
                    }
                    ...
                    $navtop.on('hover mouseenter', function () {
                        ...
                        if (wMega > maxW) {
                            wMega = Math.floor(maxW / wChild) * wChild;
                        }
                ...
                vertical: function ($navtop, fullWidth, init) {
                    if (init) {
                        methods.initMenu($navtop, fullWidth, false);
                    }
                    var menuBoxMax  = $('body');
                    if (!fullWidth) {
                        var maxWidth = 0;
                    ...
                    $navtop.on('hover mouseenter', function () {
                        ...
                        if (wMega > wMageMax) {
                            wMega = Math.floor(wMageMax / wChild) * wChild;
                        }
                        $item.find('.content-mega-horizontal').width(wMega);
                    })
                },
                ...
                megamenu: function (menu) {
                    ...
                    if (isHorizontal && navDesktop.hasClass('sticker')) {
                        methods.sticky(menu);
                    }
                    ...
                    if (navDesktop.data('breakpoint')) {
                        breakpoint = navDesktop.data('breakpoint');
                    }
                    ...
                    if (isHorizontal) {
                        ...
                        methods.vertical(leveltop, fullWidth, true);
                    }
                    // Responsive
